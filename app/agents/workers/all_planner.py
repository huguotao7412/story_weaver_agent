...
1. 必须顺应当前的情绪节奏（tension_level）：这 6-8 个微观节拍必须严格服从上方的心流节奏。例如，当前是【舒缓/日常期】，这 6-8 个节拍可以全是日常琐事、战利品清点、功法尝试、路人八卦，完全不需要强塞战斗冲突！用高分辨率填满日常。
2. 必须为每个节拍分配合理的 `word_count_weight` (如 10%, 40%)，总和应约为 100%。告诉主笔哪些是过渡场景，哪些是需要极致特写、疯狂铺垫细节的核心大轴戏！

【👑 动态对齐法则（极其重要）】：
当【本期十章梗概】的预期规划与【相关历史剧情 (RAG)】的既定事实发生冲突时（例如：大纲要求本章进城，但历史记录显示上一章已经进城了），
你必须：
1. 绝对承认【相关历史剧情】为最高真理！
2. 放弃死板的原本梗概，顺着真实历史的时间线继续往下推演新的节拍。
3. 绝对禁止“时间线倒流”或让主角去重复做已经完成的事情！
