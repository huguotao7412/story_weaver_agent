...
# 🧠 四层提示词定义区
# ==========================================
# app/agents/workers/all_planner.py (修改提示词定义区)
...
🚨 【格式强约束】：
必须且只能以纯 JSON 格式输出，严格遵循系统提供的 Schema 结构。绝对禁止输出任何 Markdown 代码块（如 ```json ），禁止包含任何前缀或后缀废话！
"""
...
🚨 【格式强约束】：
必须且只能以纯 JSON 格式输出，严格遵循系统提供的 Schema 结构。绝对禁止输出任何 Markdown 代码块，禁止废话！
"""
